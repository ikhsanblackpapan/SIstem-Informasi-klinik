	...
	public function accessRules()
{
    return array(
        ...
        // Dokter: akses terbatas (tanpa delete)
        array('allow',
            'actions' => array('index', 'view', 'create', 'update', 'admin'),
            'users' => array('@'),
            'expression' => 'Yii::app()->user->getState("role") === User::ROLE_DOKTER',
        ),
        // (Opsional) Pasien: hanya bisa lihat kunjungan sendiri
        // array('allow',
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Laporan::model()->findbyPk($_GET['id']);
			if($this->_model===null)
